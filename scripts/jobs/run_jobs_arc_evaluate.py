...
"""
# Sweep paraphrase temperatures for ARC-Challenge with Llama-3.1-8B:
python scripts/jobs/run_jobs_arc_evaluate.py \
  --arc_split ARC-Challenge \
  --model Llama-3.1 \
  --dataset_path 'artifacts/arc_challenge_paraphrases_temps/temp_{temperature}' \
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "If set, passes --dataset_path to arc_compress_evaluate.py so it loads the "
            ...
            "placeholder, e.g. 'artifacts/arc_challenge_paraphrases_temps/temp_{temperature}'."
        ),
    )
    parser.add_argument(
        "--temperatures",
        ...
        default=None,
        help=(
            "Comma-separated list of paraphrase temperatures to sweep (e.g. '0.5,1.0,1.5,2.0'). "
    ...
    if args.temperatures is None:
        ...
        if args.dataset_path is None or "{temperature}" not in args.dataset_path:
            raise SystemExit(
                ...
                "(e.g. 'artifacts/arc_challenge_paraphrases_temps/temp_{temperature}')"
            )
    workdir = os.getcwd()
