...
% {\color{red} TODO waiting for results, TODO attach table}
% TODO results

% \setcounter{table}{10}
\begin{table*}[]
    \centering
    \caption{Progressive cramming variants and key metrics across model families on \textbf{50 samples} of \textbf{Fanfics} dataset following Kuratov et al. For each family we report baseline progressive cramming, low-dimensional projection only (``dim''), activation alignment only ($\alpha$, $L$), and their combination.}
