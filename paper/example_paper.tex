...
Our study remains limited in scope: we use a small number of PG19 samples, and our causal interventions cover a single model family.
Future work should extend these interventions across architectures and develop a \emph{fast} compressor that produces semantically meaningful compression embeddings.
