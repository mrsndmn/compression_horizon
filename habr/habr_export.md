...
![Анимация: с низкоразмерной проекцией оптимизатор уходит из локального минимума и исследует несколько бассейнов реконструкции.](../poster/images/visual_abstract_pc1_pc2_joined_step100.png)

*🎬 В документе показан статичный кадр; полная анимация — `trajectory_zoom_lowdim.mp4` (в репозитории `habr/assets/`).*
...
![Траектория оптимизации в проекции на PC1–PC2 и сжимающиеся области высокой точности.](../poster/images/visual_abstract_pc1_pc2_joined.png)

*🎬 В документе показан статичный кадр; полная анимация — `trajectory_pca.mp4` (в репозитории `habr/assets/`).*
